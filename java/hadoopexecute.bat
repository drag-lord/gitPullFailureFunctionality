...
D:\projects\TestCart\java\ExcludeTest.jar;^
D:\projects\TestCart\ImportCartridge\java\ImportCartridge.jar;^
D:\designeroncloud\backend\designer-home\lib\runtime\universalrt.jar;^
...
"C:\Program Files\jdk-11.0.2\bin\java" -server -mx500m -ms200m com.volante.runtime.hadoop.simulator.HadoopSimulator %*
